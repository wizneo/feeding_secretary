	...
	<body>		
		<div data-role="page" id="memo" data-theme="a">
			...
			<div data-role="contents" data-theme="a">
				<a href="/memo/form" data-role="button">새 메모 작성</a>
				<ul data-role="listview" data-inset="true" class="ui-listview-outer" >
					<li data-role="list-divider">메모 목록</li>
					<div data-role="collapsible-set" data-scroll="true">
						<?
						if (isset($memo_list) && count($memo_list) > 0) {
							foreach ($memo_list as $row) {
								echo '<div data-role="collapsible" data-collapsed="true">';
								echo '<h3>'.$row['title'].'</h3>';
								echo '<a href="/memo/delete/'.$row['id'].'" data-role="button" data-inline="true" data-icon="delete"><font size=2pt>이 메모 삭제</font></a>';
								echo $row['created_dt'].' 작성';
